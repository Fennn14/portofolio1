...
const meta = {
    title: "Efendi",
    description: "I’m Efendi data scientist _ Full stack devloper,currently working in Berlin",
};
...
const services = [
    {
        title: "UI & UX Design",
        description: "Saya mampu merancang antarmuka pengguna yang sederhana, responsif, dan mudah digunakan dengan fokus pada pengalaman pengguna yang optimal.",
    },
    {
        title: "Web Design",
        description: "Saya berpengalaman dalam membangun tampilan website menggunakan HTML, CSS, dan React, serta memastikan desainnya konsisten dan modern.",
    },
    {
        title: "Frontend Development",
        description: "Mampu mengubah desain menjadi website interaktif menggunakan React.js dan JavaScript, serta menjaga performa dan struktur kode agar efisien.",
    },
];
...
const socialprofils = {
    ...
    linkedin: "https://www.linkedin.com/in/efendi-syahputra-323016395/",
    twitter: "https://twitter.com",
};

// Tambahkan variabel CV
const cvfile = "CV_Efendi.pdf"; // pastikan file ada di folder public
